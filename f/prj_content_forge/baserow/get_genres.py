"""
GET_GENRES - получение списка жанров из Baserow

ЧТО ДЕЛАЕТ:
- Получает все записи из таблицы жанров (table/747)
- Возвращает список жанров с id, названием и описанием

ГДЕ ИСПОЛЬЗУЕТСЯ:
- OBS Recording Handler (локальный Python скрипт)
- Любые скрипты которым нужен список жанров
...
def main() -> dict:
    ...
    @return Список жанров с полями id, name, description
    """
